...
/**
 * Entidad que representa un nivel educativo en el sistema.
 *
 * Esta clase mapea la tabla <code>tb_nivel_educativo</code> en la base de datos,
 * donde se almacenan los datos relacionados con los niveles educativos.
 *
 ...
 *   <li><code>@Table(name = "tb_nivel_educativo")</code>: Especifica la tabla de la base de datos asociada.</li>
 ...
 * Esta clase encapsula la información básica de un nivel educativo, incluyendo su identificador y nombre,
