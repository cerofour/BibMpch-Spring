 ...
 *
 * Esta clase mapea la tabla <code>tb_pais</code> en la base de datos,
 * donde se almacenan los datos relacionados con los países.
 *
 ...
 *   <li><code>@Table(name = "tb_pais")</code>: Especifica la tabla de la base de datos asociada.</li>
 ...
 * Esta clase encapsula la información básica de un país, incluyendo su identificador y nombre,
