...
/**
 * Entidad que representa un género en el sistema.
 *
 * Esta clase mapea la tabla <code>tb_genero</code> en la base de datos,
 * donde se almacenan los datos relacionados con los géneros.
 *
 * <p><strong>Atributos:</strong></p>
 * <ul>
 *   <li><code>id</code>: Identificador único del género.</li>
 *   <li><code>genderName</code>: Nombre descriptivo del género.</li>
 * </ul>
 *
 * <p><strong>Anotaciones de JPA:</strong></p>
 * <ul>
 *   <li><code>@Entity</code>: Marca esta clase como una entidad de JPA.</li>
 *   <li><code>@Table(name = "tb_genero")</code>: Especifica la tabla de la base de datos asociada.</li>
 ...
 * Esta clase encapsula la información básica de un género, incluyendo su identificador y nombre,
